const titles = [
  "Perché abbiamo le allergie? Potrebbe essere una strategia evolutiva",

  "Il dinosauro ritrovato con il pasto in bocca",

  "Gli animali più strani scoperti nel profondo oceano",

  "Come le piante comunicano sott’acqua",
